...
// Register the LuxCore plugin with the renderer plugin system.
TF_REGISTRY_FUNCTION(TfType)
{
    HdxRendererPluginRegistry::Define<HdLuxCoreRendererPlugin>();
}
...
void
HdLuxCoreRendererPlugin::DeleteRenderDelegate(HdRenderDelegate *renderDelegate)
{
